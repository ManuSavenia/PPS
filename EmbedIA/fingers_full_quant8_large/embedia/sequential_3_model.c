...
dense_layer_t init_dense_6_data(void) {
    ...
    static EMBEDIA_MODEL_STORAGE quant8 biases[] = {  // [8]
        30, -46, 9, 3, 99, 94, -23, 19  /* -0.061524, -2.109306, -0.614724, -0.785531,  1.815804,  1.672584, -1.502995, -0.358822 */
    };

    static EMBEDIA_MODEL_STORAGE dense_layer_t layer = {
        6, 8,
        weights, biases, { 890, 32 }, { 890, 32 }
    };
...
dense_layer_t init_dense_7_data(void) {
    ...
    static EMBEDIA_MODEL_STORAGE quant8 biases[] = {  // [6]
        -70, 15, -8, -26, -18, -8  /* -4.963518,  2.064179,  0.128668, -1.334169, -0.621117,  0.158444 */
    };

    static EMBEDIA_MODEL_STORAGE dense_layer_t layer = {
        8, 6,
        weights, biases, { 2692, -10 }, { 2692, -10 }
    };
