...
dense_layer_t init_dense_6_data(void) {
    ...
    static EMBEDIA_MODEL_STORAGE int32_t biases[] = {  // [8]
        -141, -4847, -1413, -1805, 4173, 3844, -3454, -825  /* -0.061524, -2.109306, -0.614724, -0.785531,  1.815804,  1.672584, -1.502995, -0.358822 */
    };

    static EMBEDIA_MODEL_STORAGE dense_layer_t layer = {
        6, 8,
        weights, biases, { 890, 32 }, { 4799, 0 }
    };
...
dense_layer_t init_dense_7_data(void) {
    ...
    static EMBEDIA_MODEL_STORAGE dense_layer_t layer = {
        8, 6,
        weights, biases, { 2692, -10 }, { 10447, 0 }
    };
